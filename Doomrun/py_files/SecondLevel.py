...
class Dungeons:
    def __init__(self, hero_x, hero_y, enemy_x, enemy_y, enemy_x2, enemy_y2, enemy_x3, enemy_y3,
        ...
        self.first_location_img = pygame.transform.scale(pygame.image.load("../images/background/background_21.png"),
                                                         (1280, 720))
        self.second_location_img = pygame.transform.scale(pygame.image.load("../images/background/background_22.png"),
                                                          (1280, 720))
        self.third_location_img = pygame.transform.scale(pygame.image.load("../images/background/background_23.png"),
                                                         (1280, 720))
        ...
        self.boss_img = pygame.transform.scale(pygame.image.load("../images/Boss/boss_second.png"), (400, 400))
        ...
        self.boss_img = pygame.transform.scale(pygame.image.load("../images/Boss/boss_second.png"), (474, 474))
        self.boss_rect = self.boss_img.get_rect()
        ...
        self.hero_attack_right_3 = pygame.image.load("../images/Hero/hero_atack_right_3.png")
        ...
        self.hero_attack_left_3 = pygame.image.load("../images/Hero/hero_atack_left_3.png")
...
def main():
    ...
    dungeons = Dungeons(100, 325, 1000, 360, 800, 320,
                        900, 80, 900, 185, 1100, 350)
    ...
    while running:
        ...
        hero_hp = f'{str(dungeons.hero_hp)} hp'
        hero_xp = f'{str(dungeons.hero_xp)} xp'
        time = f'{str(timer_value)[:5]} cekund'
